...
var action = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                branchList = _a.sent();
                console.log("\uD83D\uDE80 ~ file: _git_rb.ts ~ line 48 ~ action ~ branchList", branchList);
            ...
            case 2:
                ...
                console.log("\uD83D\uDE80 ~ file: _git_rb.ts ~ line 59 ~ action ~ selectBranches", selectBranches);
                selectedBranches = selectBranches.map(function (item) { return item.split(" - ")[0]; });
                console.log("\uD83D\uDE80 ~ file: _git_rb.ts ~ line 65 ~ action ~ selectedBranches", selectedBranches);
                return [4 /*yield*/, simple_git_1.default.deleteLocalBranches(selectedBranches)];
            case 3:
                _a.sent();
