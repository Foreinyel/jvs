...
var runCdSync = function (_path) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve) {
                var cmd = child_process_1.spawn("cd", ["."], {
                    cwd: _path,
                });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, runCdSync(selectedPath)];
                case 7:
                    _b.sent();
                    _b.label = 8;
...
var go = new commander_1.Command("go")
    .arguments("[project_name]")
    .description(chalk_1.default.green("jvs go") + " will search project in all workspaces and projects by project (folder) name and enter it", {
