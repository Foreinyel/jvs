            ...
            switch (_b.label) {
                ...
                case 5:
                    question = {
                        ...
                        choices: path
                            .sort(function (p1, p2) { return p2.closely - p1.closely; })
                            .map(function (item) { return item.project + "(" + item.path + ")"; }),
                        // rawList: {
...
var vscode = new commander_1.Command("code")
    ...
    .description(chalk_1.default.green("jvs code") + " will search project in all workspaces and projects by project (folder) name and open it with " + chalk_1.default.green("visual studio code"), {
