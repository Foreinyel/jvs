...
exports.Support = exports.padEnd = exports.findProject = exports.convertPath = exports.isPathExist = void 0;
 ...
 * @returns
 */
var Support = function (platforms, name) {
    return function (target, _, descriptor) {
        ...
        descriptor.value = function () {
            ...
            assert_1.strict(platforms.includes(platform), "Sir, `" + name + "` not supported on " + platform);
