...
var padToBash = function (paths) { return __awaiter(void 0, void 0, void 0, function () {
    var _i, paths_1, path, content;
    return __generator(this, function (_a) {
        for (_i = 0, paths_1 = paths; _i < paths_1.length; _i++) {
            path = paths_1[_i];
            if (fs_1.default.existsSync(path)) {
                try {
                    content = fs_1.default.readFileSync(path);
                    if (content.indexOf(consts_1.HotCommandsPath) >= 0) {
                        return [2 /*return*/, path];
                    }
                    fs_1.default.appendFileSync(path, "source " + consts_1.HotCommandsPath);
                    return [2 /*return*/, path];
                }
                catch (_b) { }
            }
...
var createHotCommands = function () { return __awaiter(void 0, void 0, void 0, function () {
    var paths, projects, hotCommands, file, platform, bashPath, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                hotCommands = projects.map(function (item) { return "alias go_" + item.project.replace(/-/g, "_") + "=\"cd " + item.path + "\""; });
                ...
                _a = platform;
                switch (_a) {
                    case consts_1.PLATFORM.LINUX: return [3 /*break*/, 2];
                    case consts_1.PLATFORM.DARWIN: return [3 /*break*/, 3];
                    case consts_1.PLATFORM.WIN32: return [3 /*break*/, 5];
                }
                return [3 /*break*/, 6];
            case 2: 
...
var action = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, createHotCommands()];
            case 1:
                _a.sent();
