...
exports.getConfig = exports.setWorkspace = exports.setConfig = exports.loadConfig = exports.IConfigKey = void 0;
...
var ConfigFilePath = HomePath + "/.jvs.json";
var IConfigKey;
(function (IConfigKey) {
    IConfigKey["WORKSPACE"] = "workspace";
})(IConfigKey = exports.IConfigKey || (exports.IConfigKey = {}));
var isConfExists = function () {
    return fs_1.default.existsSync(ConfigFilePath);
};
var saveConfig = function (data) {
    var file = fs_1.default.openSync(ConfigFilePath, "w");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, explorer.load(ConfigFilePath)];
            case 1:
                result = _a.sent();
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (key === IConfigKey.WORKSPACE) {
                    assert_1.strict(fs_1.default.existsSync(value), "directory not exists");
...
var convertPath = function (_path) {
    assert_1.strict(!!_path, "Sir, path of your workspace can't be null!");
    var path = _path === "." ? process.cwd() : _path;
    assert_1.strict(fs_1.default.existsSync(_path), "Sir, path of your workspace dose not exists!");
    return path;
};
var setWorkspace = function (_path) { return __awaiter(void 0, void 0, void 0, function () {
    var path, config;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                path = convertPath(_path);
                return [4 /*yield*/, exports.loadConfig()];
            case 1:
                config = _a.sent();
                config[IConfigKey.WORKSPACE] = config[IConfigKey.WORKSPACE]
                    ? !config[IConfigKey.WORKSPACE].includes(path)
                        ? __spreadArray(__spreadArray([], config[IConfigKey.WORKSPACE]), [path]) : config[IConfigKey.WORKSPACE]
                    : [path];
                saveConfig(config);
                console.log(chalk_1.default.green("Successfully set " + path + " as workspace."));
                return [2 /*return*/];
        }
    });
}); };
